...
BEGIN
    INSERT INTO READERS_AUD (EVENT_DATE, EVENT_TYPE, READER_ID, NEW_FIRSTNAME, NEW_LASTNAME,
        ...
        VALUE(CURTIME(), "INSERT", NEW.READER_ID, NEW.FIRSTNAME, NEW.LASTNAME, NEW.PESEL_ID,
              NEW.VIP_LEVEL);
END $$
...
BEGIN
    INSERT INTO READERS_AUD (EVENT_DATE, EVENT_TYPE, READER_ID, NEW_FIRSTNAME, NEW_LASTNAME,
                             NEW_PESEL_ID, NEW_VIP_LEVEL, OLD_FIRSTNAME, OLD_LASTNAME,
                             OLD_PESEL_ID, OLD_VIP_LEVEL)
        VALUE(CURTIME(), "UPDATE", OLD.READER_ID, NEW.FIRSTNAME, NEW.LASTNAME,
              NEW.PESEL_ID, NEW.VIP_LEVEL, OLD.FIRSTNAME, OLD.LASTNAME,
              OLD.PESEL_ID, OLD.VIP_LEVEL);
END $$
