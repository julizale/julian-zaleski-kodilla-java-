...
public class BookDirectoryTestSuite {
    ...
    @Nested
    @DisplayName("Test listBooksWithCondition")
    ...
    class TestListBooksInHandsOf {
        ...
        void testListBooksInHandsOfWhen0Books() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            LibraryUser libraryUser = new LibraryUser("Stefan", "Stefanik", "96081900700");
            List<Book> resultListOf0Books = new ArrayList<>();
        ...
        @Test
        void testListBooksInHandsOfWhen4Books() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            LibraryUser libraryUser = new LibraryUser("Stefan", "Stefanik", "96081900700");
            List<Book> resultListOf4Books = generateListOfNBooks(4);
            when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(resultListOf4Books);
